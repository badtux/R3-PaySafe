    ...
    if ($data) {
        ...
        if ($mailStatus == 'payment error') {
            ...
            <div style="font-family: Arial, sans-serif; color: #721c24; background-color: #f8d7da; padding: 20px; border-radius: 5px; border: 1px solid #f5c6cb;">
                <h2 style="color: #721c24; margin-top: 0;">❌ Payment Error  <img src="<?php echo ASSET_PATH_URL; ?>assets/banklogo1.png" alt="bank Icon" style="width: 24px; height: 24px; vertical-align: middle;"></h2>
