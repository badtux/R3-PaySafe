// // pay_script.js
// let BASE_URL; // Will be set dynamically after login
...
//     const tenantFromUrl = hostname.split('.')[0]; // e.g., 'malkey' from 'malkey.localhost:3008'
//     console.log('Hostname:', hostname, 'IS_LOCAL:', IS_LOCAL, 'Tenant:', tenantFromUrl); // Debug
//     if (tenantFromUrl && tenantFromUrl !== 'localhost' && tenantFromUrl !== 'go') {
//         $('#username').val(tenantFromUrl); // Prepopulate login field
//     }
...
//             : `http://${tenant}.go.digitable.io/api`;
//         console.log('BASE_URL set to:', BASE_URL); // Debug
...
//     console.log('Login - Hostname:', hostname, 'Tenant from URL:', tenantFromUrl, 'Input Tenant:', inputTenant); // Debug

//     // Validate tenant matches URL (optional, remove if not needed)
//     if (tenantFromUrl !== 'localhost' && tenantFromUrl !== 'go' && inputTenant !== tenantFromUrl) {
//         console.log('Tenant mismatch'); // Debug
//         return false;
//     }
...
//             : `http://${inputTenant}.go.digitable.io/api`;
//         console.log('Login successful, BASE_URL:', BASE_URL); // Debug
//         return true;
//     }
//     console.log('Login failed: Invalid password or tenant'); // Debug
//     return false;
// }
...
//         console.log('Checking health at:', url); // Debug
...
//         console.log('Exporting data from:', url); // Debug
//         const response = await $.ajax({
//             url: url,
//             method: 'GET'
//         });
