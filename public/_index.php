<?php 
    ...
    if(isset($_GET['sess'])) {
        ...
        curl_setopt_array($curl, array(
            CURLOPT_URL => 'https://cbcmpgs.gateway.mastercard.com/api/rest/version/65/merchant/'.$merchant.'/session',
...
<body>
    ...
    <div class="form-container">
        <div class="field-container">
            ...
            <input id="cardholder-name" maxlength="20" type="text" readonly>
        </div>
        <div class="field-container">
            <label for="card-number">Card Number</label><span id="generatecard">generate random</span>
            <input id="card-number" class="input-field" type="text" pattern="[0-9]*" inputmode="numeric" readonly>
        ...
        <div class="field-container">
            ...
            <input class="input-field" id="expirationdate" type="text" pattern="[0-9]*" inputmode="numeric" readonly>
            <input id="expirationyear" type="hidden" inputmode="numeric" readonly>
            <input id="expirationmonth" type="hidden" inputmode="numeric" readonly>
        </div>
        <div class="field-container">
            <label for="security-code">Security Code</label>
            <input class="input-field" id="security-code" type="text" pattern="[0-9]*" inputmode="numeric" readonly>
        </div>
    </div>
    ...
    <script type="text/javascript">
            ...
            PaymentSession.configure({
                ...
                fields: {
                    ...
                    card: {
                        ...
                        securityCode: '#securitycode', //'#security-code',
                        expiryMonth: '#expiry-month',
                        expiryYear: '#expiry-year',
                        nameOnCard: '#name' //'#cardholder-name'
                    }
                },
        ...
        function payby() {
            ...
            .done(function( data, textStatus, jqXHR ) {
                ...
                console.log($('expirationyear').val(expirationdate[0]));
                console.log($('expirationmonth').val(expirationdate[0]));
                console.log(data);
            });
        }
    </script>
